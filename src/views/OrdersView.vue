<template>
    ...
    <div id="modal" v-if="editMode">
        ...
        <div v-if="editAction == 'accept'" class="cover space-y-2 bg-white shadow-xl p-8 rounded-lg lg:w-1/4" style="position: absolute; top: 20%; left: 30%;">
        ...
        <div v-if="editAction == 'deny'" class="cover space-y-2 bg-white shadow-xl p-8 rounded-lg lg:w-1/4" style="position: absolute; top: 20%; left: 30%;">
            <div class="flex justify-end">
                <img src="../assets/tag-cross.svg" class="cursor-pointer" @click="() => this.editMode = false" width="30" alt="">
            </div>
            <div class="flex item-center space-x-4">
    ...
    <div class="flex flex-col">
        ...
        <table class="border-2 w-100" v-if="data !== null">
            ...
            <tr class="border-2  p-2 shadow-md hover:bg-gray-200 cursor-pointer"
            v-for="(delivery, index) in data" :key="index">
                ...
                <td @click="() => gotoEdit(delivery.id, 'accept')">
                    <button class="rounded-lg text-white">
                        <img src="../assets/tick.png" style="min-width: 40px;" alt="">
                    </button>
                </td>

                <td @click="() => gotoEdit(delivery.id, 'deny')">
                    <button class="rounded-lg text-white">
                        <img src="../assets/x.png" style="min-width: 40px;" alt="">
                    </button>
                </td>
            </tr>
        </table>
